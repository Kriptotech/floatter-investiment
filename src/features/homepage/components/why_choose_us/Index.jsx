    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.right}>
                ...
                <h3>Pacotes & Valor</h3>
                <p>
                    Pacote mínimo de 20mt "vinte meticais", comece a investir
                    com investimentos mínimos no valor certo que confere ao teu
                    bolso. Uma plataforma de fácil acesso e simples de usar.
                </p>

                <h3>Investir & Bónus</h3>
                <p>
                    Não há restrições na plataforma em relação ao número de
                    Pacotes a Investir que podem ser pacotes em simultâneo. Você
                    pode comprar vários pacotes ao mesmo tempo e continuar
                    negociando e ganhar bónus diariamente.
                </p>
